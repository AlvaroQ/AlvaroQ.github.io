export const es = {
  ...
  bioP5: 'Mi foco actual: <strong>Orquestación de Agentes IA</strong> con gestión de <strong>Skills</strong>, <strong>LangChain</strong>, <strong>MCP</strong>... Construyo sistemas inteligentes que integran IA en flujos de trabajo reales — desde asistentes de código hasta pipelines de datos automatizados. Actualmente investigo <strong>Hermes-Agent</strong> y una solución con <strong>memoria inteligente compartida</strong> con <strong>arquitectura local-first</strong> que me permite optimizar mis flujos de trabajo multi-entorno entre <strong>móvil, MAC y PC</strong>.',

  platformsNum: "4",
  platformsLabel: "ANDROID · iOS · WEB · DESKTOP",
  builtWithTech: "SITIO CONSTRUIDO CON",
