...
export const en: Strings = {
  ...
  subtitle: "FULL-STACK ENGINEER | MOBILE · WEB · AI",
  platforms: "Android | iOS | KMP | Web | CI/CD | AI Agents",
  builtWith: "Built with ",
  usingTech: " using Astro",

  // Presentation
  hiImAlvaro: "HI, I'M ALVARO",
  ...
  showcasingProjects: "Showcasing my latest AI-powered applications",
  ...
  catContact: "$ cat contact.txt",
  emailLabel: "Email: ",
  locationLabel: "Location: ",
  catLinks: "$ cat links.txt",
  availableFor: "Open to Senior/Staff roles • Remote • Full-Stack / Mobile / AI",
  ...
  // Banner
  bannerText: "I live in Madrid but work remotely, you can contact me via ",
  bannerEmail: "email",
  ...
  // Accessibility
  a11yThemeToggle: "Toggle theme",
  a11yLanguageToggle: "Change language",
  a11yNavigation: "Navigation menu",
  a11yCopyEmail: "Copy email to clipboard",
  a11yEmailCopied: "Email copied",
  a11yOpenLinkedIn: "Open LinkedIn profile",
  a11yOpenGitHub: "Open GitHub profile",
  a11yOpenProject: "Open project on GitHub",
  a11ySkillLevel: "Skill level",
};
